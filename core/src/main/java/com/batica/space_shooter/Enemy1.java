...
public class Enemy1 {
    ...
    public Enemy1(String atlasPath, String animationName, float frameDuration,
        ...
        // Set the enemy to be initially visible
        isVisible = true;
    ...
    public void takeDamage(int damageAmount) {
        ...
        if (this.health <= 0) {
            isVisible = false; // Enemy dies when health reaches 0
        }
    }
